...
// Set our API URL for earthquakes
...
d3.json(url).then(data => {
  ...
  const tectonicPlatesUrl = "path_to_your_tectonic_plates.geojson"; // Update with actual URL
  ...
  // Define the getColor function and create the legend as before
  function getColor(d) {
    return d > 90 ? '#800026' :
           d > 70 ? '#BD0026' :
           d > 50 ? '#E31A1C' :
